              ...
              <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src="./image/pizza1.jpg" className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                      <h5>Neapolitan Pizza</h5>
                      <p>If you are looking for a traditinal Italian pizza, the Neapolitan is the best option!</p>
                    </div>
                  </div>
                  <div className="carousel-item">
                    <img src="./image/pizza2.jpg" className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                  ...
                  <div className="carousel-item">
                    <img src="./image/pizza3.jpg" className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                  ...
                  <div className="carousel-item">
                    <img src="./image/pizza4.jpg" className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                  ...
                  <div className="carousel-item">
                    <img src="./image/pizza5.jpg" className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
          ...
          <div className="container">
            <div className='row'>
              ...
              <div className='col-md-3 mb-2'>
                <div className="card" >
                  <img src="image/menu1.jpg" className="card-img-top" alt="..." />
              ...
              <div className='col-md-3 mb-2'>
                <div className="card" >
                  <img src="image/menu2.jpg" className="card-img-top" alt="..." />
                  <div className="card-body">
              ...
              <div className='col-md-3 mb-2'>
                <div className="card" >
                  <img src="image/menu3.jpg" className="card-img-top" alt="..." />
                  <div className="card-body">
              ...
              <div className='col-md-3 mb-2'>
                <div className="card" >
                  <img src="image/menu4.jpg" className="card-img-top" alt="..." />
                  <div className="card-body">
